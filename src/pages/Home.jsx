  ...
  return (
    <div>
      ...
      <div className='relative mx-auto flex flex-col w-10/12 max-w-maxContent items-center text-white justify-between'>
        ...
        <div className='mx-3 my-12 shadow-[12px_12px_0px] shadow-white '>
      ...
      <div className='bg-pure-greys-5 text-richblack-700'>
            <div className='homepage_bg h-[310px]'>
                <div className='w-10/12 max-w-maxContent flex flex-col items-center justify-between gap-5 mx-auto'>
                    ...
                    <div className='flex flex-row gap-7 text-white py-5 '>
                        <CTAButton active={true} linkto={"/signup"}>
      ...
      <div className='w-10/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white'>
            ...
            <h2 className='text-center text-4xl font-semibold contrast-200 mt-10 capitalize'>review from Other Learners</h2>
