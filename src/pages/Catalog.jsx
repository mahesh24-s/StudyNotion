  ...
  return (
    <div className="w-screen">
      ...
      <div className="box-content bg-richblack-800 px-4">
        <div className="mx-auto flex py-10 w-10/12 max-w-maxContentTab flex-col justify-center gap-4 lg:max-w-maxContent ">
      ...
      <div className=" mx-auto box-content w-10/12 max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
        <div className="section_heading mb-10">Courses to get you started</div>
      ...
      {/* Section 2 */}
      <div className=" mx-auto box-content w-10/12  max-w-maxContentTab px-4  lg:max-w-maxContent">
