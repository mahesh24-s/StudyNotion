...
function Template({ title, description1, description2, image, formType }) {
  ...
  return (
    <div className="grid min-h-[calc(100vh-3.5rem)] w-screen place-items-center">
      {
        loading ? (
        ...
        : 
        (
          <div className="mx-auto flex w-10/12 max-w-maxContent justify-between gap-y-12 py-12 md:flex-row md:gap-y-0 md:gap-x-12">
