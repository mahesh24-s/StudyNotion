...
export default function CoursesTable({ courses, setCourses,courseDurationArr,setCourseDurationArr }) {
          ...
          : (
            courses?.map((course,index) => (
              <Tr key={course._id} className="flex gap-x-10 border-b border-richblack-800 px-6 py-8" >
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="text-xs text-richblack-300">
                      { course.courseDescription.split(" ").length >
                        TRUNCATE_LENGTH ? course.courseDescription.split(" ").slice(0, TRUNCATE_LENGTH).join(" ") + "..."
                ...
                <Td className="text-sm text-left font-medium text-richblack-100">
                  {courseDurationArr[index]}
                </Td>
                ...
                <Td className="text-sm font-medium text-richblack-100 ">
                  ...
                  <button disabled={loading} title="Delete" onClick={() => {
