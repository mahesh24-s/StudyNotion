...
function CourseDetails() {
  ...
  return (
    <div className="w-full bg-richblack-800">
        ...
        <div className="mx-auto box-content  2xl:relative ">
           <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
              <div className="relative block max-h-[30rem] lg:hidden overflow-hidden">
                ...
                <img src={thumbnail} alt="course thumbnail" className="aspect-auto w-full h-[400px] object-cover" />
              </div>
      ...
      <div className="box-content bg-richblack-900 py-6 lg:px-16 text-start text-richblack-5 lg:w-[1260px] mx-auto">
          ...
          <div className="max-w-[830px] ">
            ...
            <div className="mb-12 py-4">
              ...
              <div className="flex items-center gap-4 py-4">
                <img  alt="Author" src={ instructor.image ? instructor.image
