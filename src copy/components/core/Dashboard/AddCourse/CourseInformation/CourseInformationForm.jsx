  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        ...
        <input id="courseTitle" placeholder="Enter Course Title" className="form-style w-full"
      ...
      <div className="flex flex-col space-y-2">
        ...
        <textarea id="courseShortDesc" placeholder="Enter Description" className="form-style resize-x-none min-h-[130px] w-full"
      ...
      <div className="flex flex-col space-y-2">
        ...
        <textarea id="courseBenefits" placeholder="Enter benefits of the course" className="form-style resize-x-none min-h-[130px] w-full"
